...
import { MessageSquare, ArrowRight, Lock, Mail, User, AlertCircle, CheckCircle2, ShieldCheck } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#F4EEE3] flex flex-col justify-center py-12 sm:px-6 lg:px-8 selection:bg-[#3B6215] selection:text-white">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center space-y-3">
        ...
        <p className="text-sm text-[#4B4B4B]">
          14-day full access to Professional features. No credit card required.
        </p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md px-4 sm:px-0">
        <div className="bg-[#FAF7F0] py-8 px-6 sm:px-10 shadow-2xl rounded-3xl border border-[#D8CCB3]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            <button
              ...
              className="w-full py-3.5 px-4 rounded-xl bg-[#3B6215] hover:bg-[#2F5010] text-white font-bold text-sm shadow-olive-soft flex items-center justify-center gap-2 transition-all duration-200 active:scale-95 disabled:opacity-70 disabled:cursor-not-allowed cursor-pointer mt-2"
            >
              {isSubmitting ? (
        ...
        <div className="mt-6 text-center text-[11px] text-[#6B6B6B] flex items-center justify-center gap-1.5 font-medium">
          ...
          <span>AES-256 Encrypted Security & Zero Plaintext Logging</span>
        </div>
      </div>
